...
export function generateSmokeTestCases(): DeepTestCase[] {
  return [
    ...
    },
    {
      ...
      featureConfig: JSON.stringify({ model: 'zero-indic', input: 'नमस्ते, शून्या लैब्स एआई वॉइस प्लेटफ़ॉर्म में आपका स्वागत है।', gender: 'Female', voice: 'Meera (Maithili)', speed: 1.0, response_format: 'mp3' }),
      audioPath: 'N/A',
      ...
      ttsVoiceAndSpeed: 'Model: zero-indic | Gender: Female | Voice: Meera (Maithili) | Speed: 1.0x | Format: mp3',
    ...
    },
    {
      ...
      featuresEnabled: 'TTS Speech Synthesis',
      featureConfig: JSON.stringify({ model: 'zero-oriental', input: 'こんにちは、Shunya Labsの音声合成テストです。', voice: 'Standard Oriental', speed: 1.0, response_format: 'mp3' }),
      audioPath: 'N/A',
      ttsInputText: 'こんにちは、Shunya Labsの音声合成テストです。',
      translatedText: 'Hello, this is a speech synthesis test from Shunya Labs.',
      ttsVoiceAndSpeed: 'Model: zero-oriental | Voice: Standard Oriental | Speed: 1.0x | Format: mp3',
      preconditions: 'Valid API Key; TTS microservice online',
    ...
    },
    {
      ...
      featuresEnabled: 'TTS Speech Synthesis',
      featureConfig: JSON.stringify({ model: 'zero-universal', input: 'Bienvenido a la plataforma de síntesis de voz de Shunya Labs.', voice: 'Standard Universal', speed: 1.0, response_format: 'mp3' }),
      audioPath: 'N/A',
      ...
      ttsVoiceAndSpeed: 'Model: zero-universal | Voice: Standard Universal | Speed: 1.0x | Format: mp3',
      preconditions: 'Valid API Key; TTS microservice online',
    ...
    },
    {
      ...
      ttsVoiceAndSpeed: 'Model: Zero Indic | Gender: Female | Voice: Meera (Maithili) | Speed: 1.0x',
      preconditions: 'TTS workspace active',
