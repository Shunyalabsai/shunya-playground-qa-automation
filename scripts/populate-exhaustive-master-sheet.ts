...
export function generateTestCases(): DeepTestCase[] {
  ...
  const EDGE_CASES = [
    ...
    },
    {
      ...
      lang: 'auto',
      langName: 'Auto',
      audio: 'input/audio/edge/silence.wav',
      ttsText: 'N/A',
    ...
    },
    {
      ...
      lang: 'auto',
      langName: 'Auto',
      audio: 'input/audio/edge/short.wav',
      ttsText: 'N/A',
    ...
    },
    {
      ...
      lang: 'N/A',
      langName: 'N/A',
      audio: 'input/audio/edge/corrupted.wav',
      ttsText: 'N/A',
    ...
    },
    {
      ...
      lang: 'N/A',
      langName: 'N/A',
      audio: 'input/audio/edge/empty.wav',
      ttsText: 'N/A',
    ...
    },
    {
      ...
      model: 'zero-medasr',
      lang: 'en',
      langName: 'English (Medical)',
      audio: 'input/indicvoices_data/audio/Long_Medical_files/Mania (Bipolar Disorder) _ Mental State Examination (MSE) _ OSCE Guide _  SCA Case _ UKMLA _ CPSA - (320 Kbps).mp3',
      ttsText: 'N/A',
    ...
    },
    {
      ...
      lang: 'hi',
      langName: 'Hindi',
      audio: 'input/audio/reference/PeopleAreKnowledge_Gillidanda_Interview1.ogg',
      ttsText: 'N/A',
    ...
    },
    {
      ...
      lang: 'hi',
      langName: 'Hindi',
      audio: 'input/indicvoices_data/audio/Hindi/37.mp3',
      ttsText: 'N/A',
    ...
    },
    {
      ...
      langName: 'Hindi',
      audio: 'N/A',
      ttsText: 'नमस्ते! 🎉 Welcome to Shunya Labs 🔥🚀',
  ...
  for (const edge of EDGE_CASES) {
    list.push({
      ...
      model: edge.model,
      languageCode: edge.lang,
      languageName: edge.langName,
      featuresEnabled: 'Edge Case Test',
      featureConfig: '{}',
      audioPath: edge.audio,
      ttsInputText: edge.ttsText,
      ttsVoiceAndSpeed: 'N/A',
  ...
  const ORIENTAL_LANG_DEFINITIONS = [
    { code: 'ja', name: 'Japanese', voice: 'Standard Universal', speed: 1.0, format: 'mp3', native: 'こんにちは、Shunya Labsの次世代音声合成プラットフォームへようこそ。', trans: 'Hello, welcome to Shunya Labs next-generation speech synthesis platform.' },
    { code: 'ko', name: 'Korean', voice: 'Standard Universal', speed: 1.0, format: 'mp3', native: '안녕하세요, Shunya Labs 인공지능 음성 합성 플랫폼에 오신 것을 환영합니다.', trans: 'Hello, welcome to Shunya Labs artificial intelligence speech synthesis platform.' },
    { code: 'zh', name: 'Chinese', voice: 'Standard Universal', speed: 1.0, format: 'mp3', native: '您好，欢迎使用 Shunya Labs 人工智能语音合成系统。', trans: 'Hello, welcome to the Shunya Labs artificial intelligence speech synthesis system.' },
  ];

  const UNIVERSAL_LANG_DEFINITIONS = [
    { code: 'am', name: 'Amharic', voice: 'Standard Universal', speed: 1.0, format: 'mp3', native: 'እንኳን ወደ ሹንያ ላብስ የድምጽ ማቀነባበሪያ መድረክ በደህና መጡ።', trans: 'Welcome to the Shunya Labs voice processing platform.' },
    { code: 'ar', name: 'Arabic', voice: 'Standard Universal', speed: 1.0, format: 'mp3', native: 'مرحبًا بكم في منصة شونيا لابس للتوليف الصوتي بالذكاء الاصطناعي.', trans: 'Welcome to the Shunya Labs AI speech synthesis platform.' },
    { code: 'hy', name: 'Armenian', voice: 'Standard Universal', speed: 1.0, format: 'mp3', native: 'Բարի գալուստ Shunya Labs արհեստական բանականության ձայնային հարթակ:', trans: 'Welcome to the Shunya Labs artificial intelligence voice platform.' },
    { code: 'be', name: 'Belarusian', voice: 'Standard Universal', speed: 1.0, format: 'mp3', native: 'Сардэчна запрашаем на платформу сінтэзу маўлення Shunya Labs.', trans: 'Welcome to the Shunya Labs speech synthesis platform.' },
    { code: 'bg', name: 'Bulgarian', voice: 'Standard Universal', speed: 1.0, format: 'mp3', native: 'Добре дошли в платформата за гласов синтез на Shunya Labs.', trans: 'Welcome to the Shunya Labs voice synthesis platform.' },
    { code: 'my', name: 'Burmese', voice: 'Standard Universal', speed: 1.0, format: 'mp3', native: 'Shunya Labs အသံပေါင်းစပ်မှု ပလက်ဖောင်းမှ ကြိုဆိုပါသည်။', trans: 'Welcome to Shunya Labs voice synthesis platform.' },
    { code: 'hr', name: 'Croatian', voice: 'Standard Universal', speed: 1.0, format: 'mp3', native: 'Dobrodošli na platformu za sintezu glasa Shunya Labs.', trans: 'Welcome to the Shunya Labs voice synthesis platform.' },
    { code: 'cs', name: 'Czech', voice: 'Standard Universal', speed: 1.0, format: 'mp3', native: 'Vítejte na platformě pro syntézu řeči Shunya Labs.', trans: 'Welcome to the Shunya Labs speech synthesis platform.' },
    { code: 'da', name: 'Danish', voice: 'Standard Universal', speed: 1.0, format: 'mp3', native: 'Velkommen til Shunya Labs platform for talesyntese.', trans: 'Welcome to the Shunya Labs speech synthesis platform.' },
    { code: 'nl', name: 'Dutch', voice: 'Standard Universal', speed: 1.25, format: 'mp3', native: 'Welkom bij het spraaksyntheseplatform van Shunya Labs.', trans: 'Welcome to the Shunya Labs speech synthesis platform.' },
    { code: 'fil', name: 'Filipino', voice: 'Standard Universal', speed: 1.0, format: 'mp3', native: 'Maligayang pagdating sa platform ng speech synthesis ng Shunya Labs.', trans: 'Welcome to the Shunya Labs speech synthesis platform.' },
    { code: 'fi', name: 'Finnish', voice: 'Standard Universal', speed: 1.0, format: 'mp3', native: 'Tervetuloa Shunya Labs -puhesynteesialustalle.', trans: 'Welcome to the Shunya Labs speech synthesis platform.' },
    { code: 'fr', name: 'French', voice: 'Standard Universal', speed: 1.0, format: 'mp3', native: 'Bienvenue sur la plateforme de synthèse vocale intelligente de Shunya Labs.', trans: 'Welcome to the intelligent speech synthesis platform of Shunya Labs.' },
    { code: 'ka', name: 'Georgian', voice: 'Standard Universal', speed: 1.0, format: 'mp3', native: 'მოგესალმებით Shunya Labs-ის ხმის სინთეზის პლატფორმაზე.', trans: 'Welcome to the Shunya Labs voice synthesis platform.' },
    { code: 'de', name: 'German', voice: 'Standard Universal', speed: 1.0, format: 'mp3', native: 'Willkommen bei der Shunya Labs Plattform für künstliche Intelligenz und Sprachsynthese.', trans: 'Welcome to the Shunya Labs artificial intelligence and speech synthesis platform.' },
    { code: 'el', name: 'Greek', voice: 'Standard Universal', speed: 1.0, format: 'mp3', native: 'Καλώς ήρθατε στην πλατφόρμα σύνθεσης ομιλίας της Shunya Labs.', trans: 'Welcome to the Shunya Labs speech synthesis platform.' },
    { code: 'he', name: 'Hebrew', voice: 'Standard Universal', speed: 1.0, format: 'mp3', native: 'ברוכים הבאים לפלטפורמת סינתזת הדיבור של Shunya Labs.', trans: 'Welcome to the Shunya Labs speech synthesis platform.' },
    { code: 'hu', name: 'Hungarian', voice: 'Standard Universal', speed: 1.0, format: 'mp3', native: 'Üdvözöljük a Shunya Labs beszédszintézis platformján.', trans: 'Welcome to the Shunya Labs speech synthesis platform.' },
    { code: 'id', name: 'Indonesian', voice: 'Standard Universal', speed: 1.0, format: 'mp3', native: 'Selamat datang di platform sintesis suara kecerdasan buatan Shunya Labs.', trans: 'Welcome to Shunya Labs artificial intelligence speech synthesis platform.' },
    { code: 'it', name: 'Italian', voice: 'Standard Universal', speed: 1.0, format: 'mp3', native: 'Benvenuti nella piattaforma di sintesi vocale AI di Shunya Labs.', trans: 'Welcome to the Shunya Labs AI speech synthesis platform.' },
    { code: 'kk', name: 'Kazakh', voice: 'Standard Universal', speed: 1.0, format: 'mp3', native: 'Shunya Labs жасанды интеллект дауыс синтезі платформасына қош келдіңіз.', trans: 'Welcome to the Shunya Labs AI voice synthesis platform.' },
    { code: 'km', name: 'Khmer', voice: 'Standard Universal', speed: 1.0, format: 'mp3', native: 'សូមស្វាគមន៍មកកាន់ប្រព័ន្ធសំឡេងឆ្លាតវៃ Shunya Labs។', trans: 'Welcome to the Shunya Labs intelligent voice system.' },
    { code: 'ky', name: 'Kyrgyz', voice: 'Standard Universal', speed: 1.0, format: 'mp3', native: 'Shunya Labs жасалма интеллект үн синтези платформасына кош келиңиз.', trans: 'Welcome to the Shunya Labs artificial intelligence voice synthesis platform.' },
    { code: 'lo', name: 'Lao', voice: 'Standard Universal', speed: 1.0, format: 'mp3', native: 'ຍິນດີຕ້ອນຮັບສູ່ລະບົບສຽງສັງເຄາະ Shunya Labs.', trans: 'Welcome to the Shunya Labs synthesized voice system.' },
    { code: 'mk', name: 'Macedonian', voice: 'Standard Universal', speed: 1.0, format: 'mp3', native: 'Добредојдовте на платформата за синтеза на говор Shunya Labs.', trans: 'Welcome to the Shunya Labs speech synthesis platform.' },
    { code: 'ms', name: 'Malay', voice: 'Standard Universal', speed: 1.0, format: 'mp3', native: 'Selamat datang ke platform sintesis pertuturan kecerdasan buatan Shunya Labs.', trans: 'Welcome to the Shunya Labs AI speech synthesis platform.' },
    { code: 'mn', name: 'Mongolian', voice: 'Standard Universal', speed: 1.0, format: 'mp3', native: 'Shunya Labs хиймэл оюун ухаант яриа нийлэгжүүлэлтийн платформд тавтай морилно уу.', trans: 'Welcome to the Shunya Labs AI speech synthesis platform.' },
    { code: 'no', name: 'Norwegian', voice: 'Standard Universal', speed: 1.0, format: 'mp3', native: 'Velkommen til Shunya Labs talesynteseplattform.', trans: 'Welcome to the Shunya Labs speech synthesis platform.' },
    { code: 'fa', name: 'Persian', voice: 'Standard Universal', speed: 1.0, format: 'mp3', native: 'به پلتفرم سنتز گفتار هوش مصنوعی شونیا لابس خوش آمدید.', trans: 'Welcome to the Shunya Labs AI speech synthesis platform.' },
    { code: 'pl', name: 'Polish', voice: 'Standard Universal', speed: 1.0, format: 'mp3', native: 'Witamy na platformie syntezy mowy Shunya Labs.', trans: 'Welcome to the Shunya Labs speech synthesis platform.' },
    { code: 'pt', name: 'Portuguese', voice: 'Standard Universal', speed: 1.0, format: 'mp3', native: 'Bem-vindo à plataforma de síntese de voz de última geração da Shunya Labs.', trans: 'Welcome to the next-generation speech synthesis platform from Shunya Labs.' },
    { code: 'ro', name: 'Romanian', voice: 'Standard Universal', speed: 1.0, format: 'mp3', native: 'Bun venit pe platforma de sinteză vocală Shunya Labs.', trans: 'Welcome to the Shunya Labs voice synthesis platform.' },
    { code: 'ru', name: 'Russian', voice: 'Standard Universal', speed: 1.0, format: 'mp3', native: 'Добро пожаловать на платформу синтеза речи Shunya Labs.', trans: 'Welcome to the Shunya Labs speech synthesis platform.' },
    { code: 'sr', name: 'Serbian', voice: 'Standard Universal', speed: 1.0, format: 'mp3', native: 'Добродошли на платформу за синтезу говора Shunya Labs.', trans: 'Welcome to the Shunya Labs speech synthesis platform.' },
    { code: 'si', name: 'Sinhala', voice: 'Standard Universal', speed: 1.0, format: 'mp3', native: 'Shunya Labs කථන සංස්ලේෂණ වේදිකාවට සාදරයෙන් පිළිගනිමු.', trans: 'Welcome to the Shunya Labs speech synthesis platform.' },
    { code: 'sk', name: 'Slovak', voice: 'Standard Universal', speed: 1.0, format: 'mp3', native: 'Vitajte na platforme hlasovej syntézy Shunya Labs.', trans: 'Welcome to the Shunya Labs voice synthesis platform.' },
    { code: 'es', name: 'Spanish', voice: 'Standard Universal', speed: 1.0, format: 'mp3', native: 'Bienvenido a la plataforma de síntesis de voz de Shunya Labs.', trans: 'Welcome to the Shunya Labs speech synthesis platform.' },
    { code: 'sw', name: 'Swahili', voice: 'Standard Universal', speed: 1.0, format: 'mp3', native: 'Karibu kwenye jukwaa la usanisi wa sauti la Shunya Labs.', trans: 'Welcome to the Shunya Labs voice synthesis platform.' },
    { code: 'sv', name: 'Swedish', voice: 'Standard Universal', speed: 1.0, format: 'mp3', native: 'Välkommen till Shunya Labs talsyntesplattform.', trans: 'Welcome to the Shunya Labs speech synthesis platform.' },
    { code: 'tg', name: 'Tajik', voice: 'Standard Universal', speed: 1.0, format: 'mp3', native: 'Ба платформаи синтези овози Shunya Labs хуш омадед.', trans: 'Welcome to the Shunya Labs voice synthesis platform.' },
    { code: 'th', name: 'Thai', voice: 'Standard Universal', speed: 1.0, format: 'mp3', native: 'ยินดีต้อนรับสู่แพลตฟอร์มการสังเคราะห์เสียง Shunya Labs.', trans: 'Welcome to the Shunya Labs speech synthesis platform.' },
    { code: 'ti', name: 'Tigrinya', voice: 'Standard Universal', speed: 1.0, format: 'mp3', native: 'ናብ ሹንያ ላብስ መድረኽ ድምጺ ብደሓን መጻእኩም።', trans: 'Welcome to the Shunya Labs voice platform.' },
    { code: 'tr', name: 'Turkish', voice: 'Standard Universal', speed: 1.0, format: 'mp3', native: 'Shunya Labs yapay zeka ses sentezi platformuna hoş geldiniz.', trans: 'Welcome to the Shunya Labs artificial intelligence voice synthesis platform.' },
    { code: 'uk', name: 'Ukrainian', voice: 'Standard Universal', speed: 1.0, format: 'mp3', native: 'Ласкаво просимо на платформу синтезу мовлення Shunya Labs.', trans: 'Welcome to the Shunya Labs speech synthesis platform.' },
    { code: 'vi', name: 'Vietnamese', voice: 'Standard Universal', speed: 1.0, format: 'mp3', native: 'Chào mừng bạn đến với nền tảng tổng hợp giọng nói của Shunya Labs.', trans: 'Welcome to the speech synthesis platform of Shunya Labs.' },
  ];

  // 1. UI: Zero Indic Models & Voices (Specifically testing Female "Meera Maithili" Voice)
  const INDIC_TTS_UI = [
    { lang: 'en', gender: 'Female', voice: 'Meera (Maithili)', speed: '1.0', format: 'mp3', native: 'Welcome to Shunya Labs speech synthesis platform.', trans: 'Welcome to Shunya Labs speech synthesis platform.', title: 'English Speech Synthesis with Female Meera Maithili Voice' },
    { lang: 'hi', gender: 'Female', voice: 'Meera (Maithili)', speed: '1.0', format: 'mp3', native: 'नमस्ते, शून्या लैब्स एआई वॉइस प्लेटफ़ॉर्म में आपका स्वागत है।', trans: 'Hello, welcome to Shunya Labs AI voice platform.', title: 'Hindi Speech Synthesis with Female Meera Maithili Voice' },
    { lang: 'bn', gender: 'Female', voice: 'Meera (Maithili)', speed: '1.0', format: 'mp3', native: 'শূন্যা ল্যাবসে আপনাকে স্বাগতম। এটি একটি বাংলা স্পিচ টেস্ট।', trans: 'Welcome to Shunya Labs. This is a Bengali speech test.', title: 'Bengali (বাংলা) Speech Synthesis with Female Meera Maithili Voice' },
    { lang: 'ta', gender: 'Female', voice: 'Meera (Maithili)', speed: '1.0', format: 'mp3', native: 'ஷூன்யா லேப்ஸுக்கு வரவேற்கிறோம். இது தமிழ் பேச்சு சோதனை.', trans: 'Welcome to Shunya Labs. This is a Tamil speech test.', title: 'Tamil (தமிழ்) Speech Synthesis with Female Meera Maithili Voice' },
    { lang: 'te', gender: 'Female', voice: 'Meera (Maithili)', speed: '1.0', format: 'mp3', native: 'శూన్య ల్యాబ్స్‌కు స్వాగతం. ఇది తెలుగు స్పీచ్ పరీక్ష.', trans: 'Welcome to Shunya Labs. This is a Telugu speech test.', title: 'Telugu (తెలుగు) Speech Synthesis with Female Meera Maithili Voice' },
    { lang: 'mr', gender: 'Female', voice: 'Meera (Maithili)', speed: '1.0', format: 'mp3', native: 'शून्या लॅब्समध्ये आपले स्वागत आहे. मराठी आवाज चाचणी.', trans: 'Welcome to Shunya Labs. Marathi voice test.', title: 'Marathi (मराठी) Speech Synthesis with Female Meera Maithili Voice' },
    { lang: 'gu', gender: 'Female', voice: 'Meera (Maithili)', speed: '1.0', format: 'mp3', native: 'શૂન્યા લેબ્સમાં આપનું સ્વાગત છે. ગુજરાતી ભાષણ પરીક્ષણ.', trans: 'Welcome to Shunya Labs. Gujarati speech test.', title: 'Gujarati (ગુજરાતી) Speech Synthesis with Female Meera Maithili Voice' },
    { lang: 'kn', gender: 'Female', voice: 'Meera (Maithili)', speed: '1.0', format: 'mp3', native: 'ಶೂನ್ಯ ಲ್ಯಾಬ್ಸ್‌ಗೆ ಸುಸ್ವಾಗತ. ಕನ್ನಡ ಭಾಷಣ ಸಂಶ್ಲೇಷಣೆ ಪರೀಕ್ಷೆ.', trans: 'Welcome to Shunya Labs. Kannada speech synthesis test.', title: 'Kannada (ಕನ್ನಡ) Speech Synthesis with Female Meera Maithili Voice' },
    { lang: 'pa', gender: 'Female', voice: 'Meera (Maithili)', speed: '1.0', format: 'mp3', native: 'ਸ਼ੂਨਿਆ ਲੈਬਜ਼ ਵਿੱਚ ਤੁਹਾਡਾ ਸੁਆਗਤ ਹੈ। ਪੰਜਾਬੀ ਆਵਾਜ਼ ਟੈਸਟ।', trans: 'Welcome to Shunya Labs. Punjabi voice test.', title: 'Punjabi (ਪੰਜਾਬੀ) Speech Synthesis with Female Meera Maithili Voice' },
    { lang: 'en', gender: 'Female', voice: 'Meera (Maithili)', speed: '0.5', format: 'wav', native: 'Slow playback speech test for accessibility and assistive technology.', trans: 'Slow playback speech test for accessibility and assistive technology.', title: 'Slow Playback (0.5x) WAV with Female Meera Maithili Voice' },
    { lang: 'en', gender: 'Female', voice: 'Meera (Maithili)', speed: '1.5', format: 'wav', native: 'Fast playback speech test for quick audio previews and content skimming.', trans: 'Fast playback speech test for quick audio previews and content skimming.', title: 'Fast Playback (1.5x) WAV with Female Meera Maithili Voice' },
    { lang: 'en', gender: 'Female', voice: 'Meera (Maithili)', speed: '2.0', format: 'mp3', native: 'Double speed audio generation test across long paragraph texts.', trans: 'Double speed audio generation test across long paragraph texts.', title: 'Double Speed (2.0x) MP3 with Female Meera Maithili Voice' },
    { lang: 'hi-en', gender: 'Female', voice: 'Meera (Maithili)', speed: '1.0', format: 'mp3', native: 'डॉक्टर साहब, मेरा appointment confirm हो गया है for tomorrow morning at 10 AM.', trans: 'Doctor, my appointment has been confirmed for tomorrow morning at 10 AM.', title: 'Code-Mixed Hinglish Synthesis with Female Meera Maithili Voice' },
    { lang: 'hi', gender: 'Female', voice: 'Meera (Maithili)', speed: '1.25', format: 'mp3', native: 'यह भारतीय भाषाओं के लिए विशेष रूप से निर्मित आवाज है।', trans: 'This voice is specially built for Indian languages.', title: 'Hindi Speech Synthesis 1.25x Speed with Female Meera Maithili Voice' },
    { lang: 'en', gender: 'Male', voice: 'Rajesh (Hindi)', speed: '1.0', format: 'mp3', native: 'Experience natural sounding AI voices for your enterprise applications.', trans: 'Experience natural sounding AI voices for your enterprise applications.', title: 'Male Voice Option Selection (Rajesh)' },
  ];
  ...
  for (const t of INDIC_TTS_UI) {
    list.push({
      ...
      featureConfig: JSON.stringify({ model: 'Zero Indic', gender: t.gender, voice: t.voice, speed: t.speed, format: t.format }),
      audioPath: 'N/A',
  ...
  list.push(
    ...
    },
    {
      ...
      ttsVoiceAndSpeed: 'N/A',
      preconditions: 'Valid API Key',
      testSteps: '1. POST /v1/audio/transcriptions with model="zero-indic" (no file)\n2. Assert status >= 400',
